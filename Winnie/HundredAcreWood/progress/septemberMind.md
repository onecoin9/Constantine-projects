...
- **工作流规范统一**: 统一主工作流和站点工作流的修改规范，建立一致的代码结构和调用约定，提高开发效率和维护性。排期表](#任务排期表)
- [甘特图](#甘特图)
- [备用表格格式](#备用表格格式)
- [关键决策点](#关键决策点)
...
- **文档版本**: v1.17
- **更新内容**:
  - 新增 09-25 今日完成：小转台代码问题全面核对与自测，门压配方管理系统 loadTask 功能移植，主工作流与站点工作流修改规范统一。
  - 修正文档日期为当前进度（09-25）。
  - 其余保留：日志规范草案、外部依赖追踪、数据库设计、失败重试策略、决策点与风险列表等既有内容。
- **创建人**: 开发团队
