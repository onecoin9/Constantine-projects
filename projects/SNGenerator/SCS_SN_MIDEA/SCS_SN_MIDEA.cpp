// SNCustom_MIDEA.cpp : 定义 DLL 的初始化例程。
//
...
BEGIN_MESSAGE_MAP(CSNCustom_MIDEAApp, CWinApp)
END_MESSAGE_MAP()


// CSNCustom_MIDEAApp 构造

CSNCustom_MIDEAApp::CSNCustom_MIDEAApp()
{
	// TODO: 在此处添加构造代码，
...
// 唯一的一个 CSNCustom_MIDEAApp 对象

CSNCustom_MIDEAApp theApp;


// CSNCustom_MIDEAApp 初始化

BOOL CSNCustom_MIDEAApp::InitInstance()
{
...
////获取工程Tag信息
INT SNSetTagInfo(DRVSNCFGPARA*pSnCfgPara,char*pData,char* pChipName,char* pManuName)
{
	INT Ret=0;
	CDlgSNCustom *pDlgSN=reinterpret_cast<CDlgSNCustom*>(pSnCfgPara->DrvPrivData);
	if(pDlgSN){
		return pDlgSN->SetTagInfo(pData,pChipName,pManuName);
	}
