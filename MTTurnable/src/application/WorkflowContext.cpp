...
void WorkflowContext::setDutManager(std::shared_ptr<Services::DutManager> dutManager)
{
    m_dutManager = dutManager;
}

std::shared_ptr<Services::DutManager> WorkflowContext::getDutManager() const
{
    return m_dutManager;
}
