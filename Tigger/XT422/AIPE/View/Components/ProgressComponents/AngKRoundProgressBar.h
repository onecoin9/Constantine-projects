...
class AngKRoundProgressBar : public QWidget
{
	Q_OBJECT
...
public:
	AngKRoundProgressBar(QWidget *parent, BarStyle style = StyleDonut);
	~AngKRoundProgressBar();
...
protected:
	...
	//根据值画出进度条
	void drawValue(QPainter& p, const QRectF& baseRect, double value, double arcLength, const QRectF& innerRect, double innerDiameter);
