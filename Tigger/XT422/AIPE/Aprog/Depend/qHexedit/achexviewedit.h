#ifndef ACHEXVIEWEDIT_H
#define ACHEXVIEWEDIT_H

#define AcHexViewEdit_VERSION 3.0
...
class AcHexViewEdit : public QAbstractScrollArea {
  Q_OBJECT

public:
  explicit AcHexViewEdit(QWidget *parent = nullptr);
  ...
  void setViewFont(QString familyName, int size = 14);
