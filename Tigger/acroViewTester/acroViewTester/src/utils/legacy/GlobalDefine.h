...
#define TASK_PATH			"Task_Path"
#define AUTOMATIC_TSK_PATH	"Automatic_Tsk_Path"
#define EMMC_ANALYZE_IMG_PATH	"Emmc_Analyze_Img_Path"
#define BIN_FILE_PATH		"Bin_File_Path"
#define BATCH_ADD_PATH		"Batch_Add_Path"
#define EXCSD_CFG_PATH		"Excsd_Cfg_Path"
...
struct eMMCFileInfo
{
	...
	bool operator==(const eMMCFileInfo& other) const {
		
		return sFilePath == other.sFilePath
			&& sPartitionName == other.sPartitionName
			&& nStartAddr == other.nStartAddr
			&& nFileSize == other.nFileSize
			&& bSectorAlign == other.bSectorAlign;
