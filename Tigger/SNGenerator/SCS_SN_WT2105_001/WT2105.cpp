...
BEGIN_MESSAGE_MAP(CWT2105App, CWinApp)
END_MESSAGE_MAP()


// CWT2105App 构造

CWT2105App::CWT2105App()
{
	// TODO: 在此处添加构造代码，
...
BOOL SNCreateWindow(DRVSNCFGPARA *pSnCfgPara,RECT Position)
{
	...
	CDlgWT2105 *pDlgSN=new CDlgWT2105(pSnCfgPara);
	...
	if(pSnCfgPara->pParent!=NULL){
		Ret=pDlgSN->Create(CDlgWT2105::IDD,pSnCfgPara->pParent);
		if(Ret){
...
{
	CDlgWT2105 *pDlgSN=reinterpret_cast<CDlgWT2105*>(pSnCfgPara->DrvPrivData);
	if(pDlgSN){
		delete pDlgSN;
