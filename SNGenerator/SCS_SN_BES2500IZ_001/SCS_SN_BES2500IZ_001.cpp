// SNCustom_FC001.cpp : 定义 DLL 的初始化例程。
//
...
// 唯一的一个 CSNCustom_FC001App 对象

CSNCustom_FC001App theApp;


// CSNCustom_FC001App 初始化
...
BOOL SNCreateWindow(DRVSNCFGPARA *pSnCfgPara,RECT Position)
{
	...
	if(pSnCfgPara->pParent!=NULL){
		...
		if(Ret){
			...
			pDlgSN->m_ComBoxElephantFrom.AddString("本地");
			pDlgSN->m_ComBoxElephantFrom.AddString("Mes");
			pDlgSN->m_ComBoxSoundPlusFrom.AddString("本地");
			pDlgSN->m_ComBoxSoundPlusFrom.AddString("Mes");	
		}
	}
__end:
