...
- 复用现有样式框架，仅新增：状态栏扩展（温度/压力实时值 + 稳定指示）、托盘转移对话框、制作流程“一键执行”按钮。
- 所有新增操作需有热键/最少点击路径。
- 日志区域新增“数据追踪过滤（DUT SN / Zone / Run）”。
...
- **下次更新**: 2025-09-06
- **文档版本**: v1.3
- **更新内容**: 补充外部依赖、配置与数据库设计、失败重试策略、决策点与风险列表；新增9月1-5日完成任务（需求梳理、自定义步骤修复、数据库功能50%-90%、压力设备TCP集成、配方管理系统开发完毕、QSS加载调整、异步数据库架构、日志统一、DatabaseCenterDialog、MES接口、索引优化）
- **创建人**: 开发团队
